...
*/
     ...
     /*  1. Cufon font replacement
     ==========================================*/
     Cufon.replace('ul.menu li a, div#hidden_items ul li a, div.title h2',{ hover: true, fontFamily: 'Andada' });
...
$(window).load(function() {
     ...
     $('ul.sortablePortfolio li .item_content ').hoverIntent(
               function(){ $(this).find('div.hidden').stop().show('clip'); return false; },
               function(){ $(this).find('div.hidden').stop().hide('clip'); return false; }
     );
